...
public class Calc {
	...
	public double modulus(double firstNum, double secondNum) {
		  return(firstNum % secondNum);
	}
	...
	public static void wholeThing(){
	  ...
	  System.out.println("Welcome to the Java CLI Calculator! \n This calculator performs operations on two numbers. \n Please type your first number \n Type 'exit' to exit at anytime! \n ");
	      ...
	      String operator = sc1.next();
	       ...
	       switch (operator){
	         case "+":
	            System.out.println(calc1.num1 + " + " + calc1.num2 + " = "+calc1.add(firstNum, secondNum));
	            backToMainMenu();
	            break;
	          case "-":
	            System.out.println(calc1.num1 + " - " + calc1.num2 + " == "+calc1.subtract(firstNum, secondNum));
	            backToMainMenu();
	            break;
	          case "*":
	            System.out.println(calc1.num1 + " * " + calc1.num2 + " = "+calc1.multiply(firstNum, secondNum));
	            backToMainMenu();
	            break;
	          case "**":
	            ...
	            break;
	          case "/":
	            System.out.println(calc1.num1 + " / " + calc1.num2 + " = "+calc1.divide(firstNum, secondNum));
	            backToMainMenu();
	            break;
	          case "%":
	          	System.out.println(calc1.num1  + " modulus " + calc1.num2+ " = "+calc1.modulus(firstNum, secondNum));
	          	backToMainMenu();
	              break;
	          case "exit":
	            System.exit(0);
